...
/**
 * Room copy of a [com.bmw.assistant.data.model.Module]. Definitions are seeded from the
...
/**
 * Room copy of a [com.bmw.assistant.data.model.CodingItem]. Complex fields (options, ecuMap)
 * are stored as JSON.
 */
