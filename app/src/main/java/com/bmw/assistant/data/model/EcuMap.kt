 ...
 * knowledge base doc. [com.bmw.assistant.core.coding.CodingEngine] refuses to build a real
 * write frame unless [verified] is true, so fabricated maps can never be pushed to hardware
 * by accident.
 *
